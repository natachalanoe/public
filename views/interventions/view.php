...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Test : ajouter un log au clic sur le bouton de fermeture
    const closeButton = document.querySelector('button[data-bs-target="#closeInterventionModal"]');
    if (closeButton) {
        closeButton.addEventListener('click', function() {
            console.log('DEBUG: Bouton de fermeture cliqué');
        });
    } else {
        console.error('DEBUG: Bouton de fermeture non trouvé');
    }
