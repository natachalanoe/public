...
/**
 * Vue de la liste des contrats hors contrat facturable
 * Affiche la liste de tous les contrats hors contrat facturable
 */
...
setPageVariables(
    'Contrats Hors Contrat Facturable',
    'hors_contrat_facturable'
);
...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="d-flex bd-highlight mb-3">
        <div class="p-2 bd-highlight"><h4 class="py-4 mb-6">Contrats Hors Contrat Facturable</h4></div>
    </div>
    ...
    <div class="table-responsive">
        <table id="horsContratFacturableTable" class="table table-striped table-hover dt-responsive">
            <thead>
                <tr>
                    ...
                    <?php foreach ($contracts as $contract): ?>
                        <tr>
                            <td data-label="Nom du contrat">
                                <a href="<?php echo BASE_URL; ?>hors_contrat_facturable/view/<?php echo $contract['id']; ?>" 
...
$(document).ready(function() {
    $('#horsContratFacturableTable').DataTable({
        responsive: true,
        language: {
