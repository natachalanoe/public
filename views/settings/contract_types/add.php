<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="d-flex bd-highlight mb-3">
        <div class="p-2 bd-highlight">
            <h4 class="py-4 mb-6">
                <i class="bi bi-plus me-2 me-1"></i>Ajouter un type de contrat
            </h4>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="<?= BASE_URL ?>settings/contractTypes/create" method="POST" id="contractTypeForm">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control bg-body text-body" 
                                      ...
                                      name="description" 
                                      rows="3"
                                      placeholder="Description détaillée du type de contrat..."><?= htmlspecialchars($formData['description'] ?? '') ?></textarea>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   required 
                                   min="0"
                                   value="<?= htmlspecialchars($formData['default_tickets'] ?? '0') ?>"
                                   placeholder="0">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   required 
                                   min="0"
                                   value="<?= htmlspecialchars($formData['nb_inter_prev'] ?? '0') ?>"
                                   placeholder="0">
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-lg me-2 me-1"></i>Créer le type de contrat
                            </button>
                        </div>
                    </div>
                </div>
